  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless scheduling with QA Doctor Appointment System - your ultimate solution for efficient healthcare management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless scheduling with QA Doctor Appointment System - your ultimate solution for efficient healthcare management.`}
            </Text>
            <Box
